...
function Footer() {
    ...
    <div id='realcontact'>
        <a  href='https://github.com/dhruvtyagi18' target='_blank' rel='noopener noreferrer'>
            <GitHubIcon  className='icon' fontSize='large' ></GitHubIcon>
        </a>
        <a href='https://www.linkedin.com/in/dhruv-tyagi-58a9aa22a/'  target='_blank' rel='noopener noreferrrer'>
